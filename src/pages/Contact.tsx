  ...
  const contactInfo = [
    {
      ...
      details: ["Rua das Inovações, 123", "Distrito Tecnológico", "São Paulo - SP, 01234-567"],
    },
    {
      icon: <Phone className="h-6 w-6" />,
      title: "Telefone & WhatsApp",
      details: ["+55 (11) 9999-8888", "+55 (11) 8888-7777", "Atendimento: Seg-Sex 8h-18h"],
    },
    {
      icon: <Mail className="h-6 w-6" />,
      title: "E-mail",
      details: ["contato@embtech.com.br", "vendas@embtech.com.br", "suporte@embtech.com.br"],
    },
    {
      icon: <Clock className="h-6 w-6" />,
      title: "Horário de Funcionamento",
      details: ["Segunda à Sexta: 8h às 18h", "Sábado: 8h às 12h", "Emergências: 24/7"],
    },
  ];
          ...
          <div className="container mx-auto px-4 lg:px-6">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <div className="flex flex-wrap gap-2 justify-center">
                <Badge variant="secondary" className="text-sm px-4 py-2">Consultoria Gratuita</Badge>
